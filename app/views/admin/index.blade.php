...
<body>
    <div class="container-fuild">
        <div class="row flex-nowrap">
            ...
            <div class="col-2 bg-dark sidebar fixed-left " style="max-height:695px">

                <div class="mt-4 position-sticky">
                    <a href=""
                        class="text-white text-decoration-none d-none d-sm-inline d-flex align-items-center ms-4"
                        role="button">
                        <img src="{{BASE_URL}}img/logo/logo_png.jpg" width="40" height="40" class="rounded-circle me-2" alt="">
                    ...
                    <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="menu">
                            ...
                            <ul class="nav collapse ms-1  " id="category">
                                <li class="nav-item ">
                                    <a href="{{ BASE_URL }}category/show" class="nav-link text-white"
                                        aria-current="page">Category manager </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ BASE_URL }}category/store" class="nav-link text-white">add
                                        category</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item ">
                            ...
                            <ul class="nav collapse ms-1 multi-collapse" id="products">
                                <li class="nav-item ">
                                    <a href="#" class="nav-link text-white" aria-current="page">Item1</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="col-10">
                ...
                <div class="card  m-2" style="height: 480px; overflow-y: auto;">
